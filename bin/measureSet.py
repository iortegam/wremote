...
def main(argv):
    ...
    #-------------------
    #macroInSb    = r"C:\bin\CalcGainInSb.mtx" 
    #macroMCT     = r"C:\bin\CalcGainMCT.mtx"

    #xpmPath       = r"C:\Users\Public\Documents\Bruker\OPUS_7.8.44\XPM\Solar"
    #dataPath      = r"Y:\id\fl0"
    #dataPath      = r"C:\data"
    #gainFlg       = r"1"
    #timeoutFlg    = r"450"
    #dataServer_IP = "128.117.32.93" #"127.0.0.1"
    #portNum       = 5555
    ...
    #------------------------------------
    # ESTIMATE TIME FOR SET OF OBSERVATIONS (CONSERVATIVE 10/MIN SPECTRA) 
    #------------------------------------
    max_time     = 10*(iters)*(len(fltrs))*60.   # MINUTES
    timeit_ini   = timeit.default_timer()   #elapsed time in seconds
    ...
    # Get Defaults
    #----------------------------------
    #ctlFile = dataServer.getParam("FILE_DEFAULTS")
    #print ctlFile
    #ctlFvars = mainInputParse(ctlFile)
    if ln2Flg:
    ...
    for i in range(iters):
        for fltr in fltrs:
            ...
            timeit_flti = timeit.default_timer()
            ...
            while True:
                ...
                timeit_crn     = timeit.default_timer()
                timeit_diff    = timeit_crn - timeit_ini
                
                if timeit_diff > max_time:
                    dataServer.setParam("TRACKER_CMND CLOSE")
