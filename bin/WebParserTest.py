...
class WebParser(FTIRdataClient):
    ...
    def checkWebAddress(self):
        ...
        try:
            ...
            print " at : {}".format(dt.datetime.utcnow())
            return False
...
if __name__ == "__main__":
    ...
    #ewsData = FTIRwebParser(WebPageParse_IP='128.171.190.216',TCP_IP_in=ctlFvars["FTS_DataServ_IP"],
    #                        TCP_Port_in=int(ctlFvars["FTS_DataServ_PORT"]),BufferSize_in=int(ctlFvars["FTS_DATASERV_BSIZE"]))
    ...
    while True:
        ...
        for k in ewsData.data:
            print(k, ewsData.data[k])
        ...
        try:
            ...
            print "Successfully obtained EWS Diagnostics data at........{}".format(dt.datetime.utcnow())
        except:
