...
#RefOffset = 204800  #Faulhaber motor steps per 1mm using certain incremental encoder TTL signal for position (ORIGINAL)
...
def MoveAbsWait(Pos_X, Pos_Y, Zero_X=0,Zero_Y=0):
    ...
    x_pos = round(Pos_X+Zero_X)
    y_pos = round(Pos_Y+Zero_Y)
