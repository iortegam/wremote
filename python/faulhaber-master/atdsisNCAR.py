...
class atdsisClass(mc.Controller, FTIRdataClient):
    ...
    def readSensor(self):
        ...
        try:
            ...
            self.atdsis['ATDSIS_ANIN1(0X2314.07)'] = float(AnIn_1)/10000.
           #print(struct.unpack('<f', AnIn_1) )
           #print(struct.unpack('>f', AnIn_1) )
        except:
            print('Error 3')
        ...
        try:
            ...
            self.atdsis['ATDSIS_ANIN2(0X2314.08)'] = float(AnIn_2)/10000.
           #print(struct.unpack('<f', AnIn_2) )
           #print(struct.unpack('>f', AnIn_2) )
        except:
            print('Error 4')
        ...
        try:
            AnIn_1 = self.ReadAnalogIn(address=0x2313, subindex=0, node = b'\x01')
            print('\nAnalog Input 1 (0X2313.0): {}'.format(AnIn_2))
            #self.atdsis['ATDSIS_ANIN2(0X2314.0)'] = float(AnIn_2)/10000.
           #print(struct.unpack('<f', AnIn_2) )
           #print(struct.unpack('>f', AnIn_2) )
        except:
            print('Error 4')
